                ...
                c => new
                    {
                        ...
                        AboutContent1 = c.String(maxLength: 100),
                        AboutContent2 = c.String(maxLength: 100),
                    })
                ...
                c => new
                    {
                        ...
                        NameSurname = c.String(maxLength: 60),
                        AuthorImage = c.String(maxLength: 100),
                        AuthorAbout = c.String(maxLength: 200),
                    })
                ...
                c => new
                    {
                        ...
                        NameUsername = c.String(maxLength: 70),
                        Mail = c.String(maxLength: 60),
                        Subject = c.String(maxLength: 50),
                        Message = c.String(maxLength: 350),
                    })
